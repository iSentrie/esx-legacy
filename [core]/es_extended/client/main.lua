...
if not Config.OxInventory then
	...
	AddEventHandler('esx:createMissingPickups', function(missingPickups)
		for pickupId, pickup in pairs(missingPickups) do
			TriggerEvent('esx:createPickup', pickupId, pickup.label, vector3(pickup.coords.x, pickup.coords.y, pickup.coords.z-.5), pickup.type, pickup.name, pickup.components, pickup.tintIndex)
		end
	end)
end
